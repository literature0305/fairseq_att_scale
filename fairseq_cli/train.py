...
def train(
    ...
    # Initialize data iterator (validation)
    ...
    for i, samples in enumerate(progress):
        # random sampling in valid set
        valid_rand_num = torch.randperm(len(progress_valid))[0]
        ...
        with metrics.aggregate("train_inner"), torch.autograd.profiler.record_function(
            ...
            log_output = trainer.train_step(samples, samples_valid, epoch_itr.epoch)
